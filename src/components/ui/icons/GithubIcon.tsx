...
const GithubIcon: React.FC<GithubIconProps> = ({ url }) => (
    <div className="socialContainer h-[1.9rem] w-[1.9rem] md:h-[2rem] md:w-[2rem]">
        <a href={url} target="_blank" rel="noopener noreferrer" aria-label="Github profile" title="Github">
            <svg
