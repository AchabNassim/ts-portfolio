...
function App() {
  return (
    <div 
      id="app" 
      className="min-h-auto lg:min-h-screen flex justify-center items-center my-2 lg:my-0 py-4 lg:py-0"
    >
      <div 
        id="appContainer" 
      ...
      >
        <div 
          id="heroContainer" 
          className="w-[96%] h-auto lg:w-[44%] xl:w-[38%] lg:h-[94%] mx-2 animate-appear-bottom"
        >
          <HeroSection />
        </div>
        <div 
